...
import static com.itheima.jdbc.utils.JDBCUtils.*;

//ResultSetHandler的实现类
public class DBUtilsDemo3 {
    @Test
    //ArrayHandler:将一条记录封装到一个object 数组中

    public void demo1() throws SQLException {
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        Object[] objs = queryRunner.query("select * form account where id = ?",new ArrayHandler(),1);
    ...
    public void demo2() throws SQLException {
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        List<Object[]> list = queryRunner.query("select * form account",new ArrayListHandler());
    ...
    public void demo5() throws SQLException {
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        Map<String,Object> map = queryRunner.query("select * form account where id = ?",new MapHandler(),4);
    ...
    public void demo6() throws SQLException {
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        List<Map<String,Object>> list = queryRunner.query("select * form account",new MapListHandler());
    ...
    public void demo7() throws SQLException {
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        List<Object> list = (List<Object>) queryRunner.query("select name,money from account",new ColumnListHandler("name"));
    ...
    public void demo9() throws SQLException{
        QueryRunner queryRunner = new QueryRunner(JDBCUtils2.getDataSource());
        Map<Object,Map<String,Object>> map = (Map<Object, Map<String, Object>>) queryRunner.query("select * from account",new KeyedHandler("id"));
