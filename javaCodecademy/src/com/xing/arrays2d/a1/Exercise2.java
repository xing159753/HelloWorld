...
public class Exercise2 {
    public static void main(String[] args) {
        ...
        //When no one is looking , you want to modify the game to where you, 'O', wins the game. Replace the game board so that all X`s are O`s are X`s. Do this in one line with initializer lists.
