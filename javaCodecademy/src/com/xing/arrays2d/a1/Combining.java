...
public class Combining {
    public static void main(String[] args) {
        ...
        //Now that you have your empty image, use nested for loops to copy over the data form the original image to the new image, make sure not to include the cropped out columns;
