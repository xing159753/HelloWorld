package com.xing.qqserver.service;

import com.xing.qqcommon.Message;
import com.xing.qqcommon.MessageType;
import com.xing.qqcommon.User;
        ...
        try {
            ...
            while (true) {//当和某个客户端连接后，会继续监听，因此while
                ...
                if (checkUser(u.getUserId(),u.getPassword())) {//登录通过
                    ...
                    //创建一个线程，和客户端保存通信，该线程需要持有socket对象
