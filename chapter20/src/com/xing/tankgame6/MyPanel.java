...
//为了让panel不停的重绘子弹，需要将 MyPanel 实现Runnable,当做一个线程使用
public class MyPanel extends JPanel implements KeyListener ,Runnable{
    ...
    public MyPanel(String key) {
        ...
        //将MyPanel对象的enemyTanks设置给Recorder 的 enemyTanks
...
//        image3 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource(""));
    ...
    public void paint(Graphics g) {
        super.paint(g);
        g.fillRect(0, 0, 1000, 750);//填充举行，默认黑色
        showInfo(g);
...
//            g.draw3DRect(hero.shot.x,shot.y,1,1,false);
...
//        }
    ...
    //编写方法，判断我放的子弹是否击中敌人坦克
    //什么时候判断我方的子弹是否击中敌人的坦克 ? run方法
        ...
        switch (enemyTank.getDirect()) {
            ...
            case 2 ://坦克向下
                ...
                && s.y > enemyTank.getY() && s.y < enemyTank.getY() + 60) {
                    ...
                    //当我们的子弹击中敌人坦克后，将enemyTank从Vector拿掉
            ...
            case 1://坦克向右
            case 3://坦克向左
                if (s.x > enemyTank.getY() && s.x < enemyTank.getY() + 60
    ...
    @Override
    public void run() {//每隔 100毫秒，区域重绘,刷新绘图区域，子弹就移动
