...
-- 3. 电邮不能够重复
-- 4. 客户的性别【男】【女】 check枚举。。
-- 5. 单价unitprice在 1.0 - 9999.99之间 check
...
CREATE TABLE customer(
	...
	`sex` ENUM('nan','nv') NOT NULL, -- 这里老师使用的枚举类型，是生效
	card_Id CHAR(18));
...
CREATE TABLE purchase(
	...
	customer_id CHAR(8) NOT NULL DEFAULT '', -- 外建约束在后
	goods_id INT NOT NULL DEFAULT 0, -- 外建约束在后
