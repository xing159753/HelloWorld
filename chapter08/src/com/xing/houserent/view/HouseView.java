package com.xing.houserent.view;

import com.xing.houserent.domain.House;
import com.xing.houserent.service.HouseService;
import com.xing.houserent.utils.Utility;
...
public class HouseView {
    ...
    public void update() {
        ...
        //根据输入的updateId,查找对象
        //返回的是引用类型[即：就是数组的元素]
        //house.setXxx(),就修改HouseService中houses数组的元素！！！！
    ...
    public void delHouse() {
        ...
        //编写ListHouses()显示市房屋列表
        public void ListHouse () {
            System.out.println("====================房屋列表=============");
            System.out.println("编号\t\t房主\t\t电话\t\t地址\t\t月租\t\t状态（未出租/已出租)");
            House[] houses = houseService.list();//得到所有房屋信息
            for (int i = 0; i < houses.length; i++) {//大家想想，这里老韩有什么坑？雷，坑
                if (houses[i] == null) {//如果为空就不要在显示了
                    break;
                }
