...
public class HashSetSource {
    public static void main(String[] args) {
        ...
        hashSet.add("php");//到此位置，第二次add分析完毕
        hashSet.add("java");
        ...
        //2.2 就放在改为置 tab[i] = newNode(hash, key, value, null)
        ...
        //   注意把元素添加到链表后，立即判断 该链表是否已经达到8个节点
        //   ,就调用treeifyBin() 对当前的这个链表进行树化（转成红黑树）
        //   注意在转成红黑树时，要进行判断，判断条件
